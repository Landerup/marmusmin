                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <a href="/profile"><button class="btn btn-m my-1 bg-success text-light border rounded">{{ Auth::user()->name }}</button></a>
                                <div>
                                    <a class="dropdown-item btn btn-m bg-success text-light border rounded" href="{{ route('logout') }}"
